...
public interface LocalityRepository extends JpaRepository<Locality, Long> {
    ...
    @Query("select locality from Locality locality where (locality.name = :name)" +
            "and (:type is null or locality.type = :type) and (:address is null or locality.address = :address)")
