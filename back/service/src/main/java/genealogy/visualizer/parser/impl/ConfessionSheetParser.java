...
public class ConfessionSheetParser extends FamilyRevisionSheetParser {
    ...
    public ConfessionSheetParser(FamilyRevisionDAO familyRevisionDAO, ArchiveDocumentDAO archiveDocumentDAO, ParamDAO paramDAO) {
    ...
    @Override
    public String type() {
        return ArchiveDocumentType.CS.getName();
    }
}
